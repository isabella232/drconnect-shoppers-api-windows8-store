(function () {
    /**
     * DataAdapter that contains the items specified on groupData
     * groupData should contain {key: The Key of the group (corresponds to the groupKey in the itemsList),
     *                           label: Group label that will be used to show in the list on the page
     *                           firstItemIndex: First item on the list where the group begins
     *
     */
    var InMemoryGroupDataAdapter = DR.Class.extend(
         ...
         */
        {
             ...
             * The count is the length of groupData
             */
            getCount: function () {
                var that = this;
