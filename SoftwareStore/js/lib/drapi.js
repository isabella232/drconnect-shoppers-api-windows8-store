(function () {
    ...
    define('auth/AuthManager', ['q', 'view/AuthWindowView', 'view/AuthIFrameView'], function (Q, AuthWindowView, AuthIFrameView) {
        /**
        ...
        Session.prototype.anonymousLogin = function () {
            ...
            return this.connection.submitForm(uri, fields, {})
                .then(function (data) {
                    ...
                    console.log("[DR Api Library] Anonymous token obtained: " + that.token);
